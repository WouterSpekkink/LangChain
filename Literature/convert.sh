...
total=$(find /home/wouter/Documents/LangChain_Nexis/Nexis/data/Nexis -type f -name "*.pdf" | wc -l)

find /home/wouter/Documents/LangChain_Nexis/Nexis/data/Nexis -type f -name "*.pdf" | while read -r file
do
